      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center lg:h-[540px] lg:flex-row">
        <div className="flex-1 text-center lg:text-left">
          <h1 className="mb-6 font-jakarta text-4xl font-bold lg:text-6xl">
            <Translate id="heroSection.title">Build with UniPass SDK</Translate>
          </h1>
          <p className="text-sm text-text-400  lg:text-base">
            <Translate id="heroSection.subTitle">
              UniPass SDK provides a seedless and gasless user experience based
          ...
          <div className="mt-8 mb-8 flex flex-col gap-4 lg:flex-row">
            ...
            >
              <Translate id="heroSection.start">Start building</Translate>
            </Link>
            {/* <Link
